            ...
            <div class="container mt-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label style="color:black; font-weight:bold;">Deskripsi Keterampilan</label>
                            <textarea class="form-control" name="deskripsiketerampilan" id="deskripsiketerampilan" rows="5">{{ $pengguna->deskripsiketerampilan }}</textarea>
                        </div>
                    </div>
